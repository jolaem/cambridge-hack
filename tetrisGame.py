...
class Block(pygame.sprite.Sprite):
    def __init__ (self,block_type, xy):
        ...
        if block_type==1:
            self.image =pygame.image.load( os.path.join( 'basic_block1.png' ))
        elif block_type==2:
            self.image =pygame.image.load( os.path.join( 'basic_block2.png' ))
        elif block_type==3:
            self.image =pygame.image.load( os.path.join( 'basic_block3.png' ))
        elif block_type==4:
            self.image =pygame.image.load( os.path.join( 'basic_block4.png' ))
        elif block_type==5:
            self.image =pygame.image.load( os.path.join( 'basic_block5.png' ))
        self.image.convert()
    ...
    def run(self):
        ...
        while running and not lost:
            ...
            if not self.current_tetra:
                ...
                #self.displayGrid()
            pygame.display.set_caption('Tetris for you neck health!')# %d fps' % self.clock.get_fps())
